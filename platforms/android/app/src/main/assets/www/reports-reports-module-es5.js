...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["reports-reports-module"], {
  ...
  function srcAppReportsReportsPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".header-row {\n  background: #7163AA;\n  color: #fff;\n  font-size: 18px;\n}\n\nion-col {\n  border: 1px solid #ECEEEF;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppReportsReportsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ReportsPage = /*#__PURE__*/function () {
      function ReportsPage(servicio, storage, loading) {
      ...
      _createClass(ReportsPage, [{
        ...
        key: "Pedido_Listado_report",
        value: function Pedido_Listado_report(fecha_ini, fecha_fin) {
                    ...
                    this.servicio.report({
                      ...
                      if (data != null) {
                        ...
                        _this.pedidos.forEach(function (element) {
                          ...
                          _this.totalT = _this.totalT + parseFloat(element.total);
                        });

                        l.dismiss();
                      } else {
                        _this.servicio.Mensaje('No hay pedidos para mostrar', 'danger');
        ...
        value: function selectDefault() {
          this.fecha_ini = moment__WEBPACK_IMPORTED_MODULE_5__(new Date()).format("YYYY-MM-DD" + ' 00:00:00');
          this.fecha_fin = moment__WEBPACK_IMPORTED_MODULE_5__(new Date()).format("YYYY-MM-DD" + ' 23:59:00');
          this.Pedido_Listado_report(this.fecha_ini, this.fecha_fin);
        }
      }, {
        key: "selectFechas",
        value: function selectFechas() {
          console.log('prueba');
          this.fecha_ini = null;
          this.fecha_fin = null;
          this.segment = 'rango';
                ...
                switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    ...
                    if (this.fecha_ini == null) {
                      ...
                      this.fecha_ini = moment__WEBPACK_IMPORTED_MODULE_5__(this.fecha_ini).format("YYYY-MM-DD" + ' 00:00:00');
                      this.fecha_fin = moment__WEBPACK_IMPORTED_MODULE_5__(this.fecha_fin).format("YYYY-MM-DD" + ' 23:59:00');
                      this.Pedido_Listado_report(this.fecha_ini, this.fecha_fin);
                      l.dismiss();
                    }
