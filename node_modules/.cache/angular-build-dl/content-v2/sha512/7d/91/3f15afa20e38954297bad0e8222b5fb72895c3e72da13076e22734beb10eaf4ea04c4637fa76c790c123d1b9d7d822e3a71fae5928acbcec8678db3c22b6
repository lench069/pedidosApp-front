...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["inicio-cliente-inicio-cliente-module"], {
  ...
  function srcAppInicioClienteInicioClientePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var InicioClientePage = /*#__PURE__*/function () {
      function InicioClientePage(servicio, loading, alert, storage) {
      ...
      _createClass(InicioClientePage, [{
                ...
                switch (_context3.prev = _context3.next) {
                  ...
                  case 2:
                    ...
                    this.servicio.Producto_Listado().subscribe(function (data) {
                      ...
                      _this2.productos.forEach(function (producto) {
                        producto.cantidad = 0;
                      });
        ...
        key: "remove",
        value: function remove(producto, i) {
        ...
        key: "addProducto",
        value: function addProducto(producto, i) {
          var cont = 0;

          if (producto.cantidad != 0) {
            for (var _i = 0; _i < this.pedidolocal.length; _i++) {
              if (this.pedidolocal[_i].codigo == producto.codigo) {
                this.pedidolocal[_i] = producto;
                cont++;
                console.log('aqui');
            ...
            this.storage.set('pedidos', this.pedidolocal).then(function (data) {
              producto.cantidad = 0;
            });
        ...
        key: "selectCategoria",
        value: function selectCategoria(categoria) {
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 3:
                    l = _context4.sent;
                    l.present();
                    this.servicio.Buscar_Productos_Categoria(categoria.id).subscribe(function (data) {
                      _this3.productos = data.info.items;

                      _this3.productos.forEach(function (producto) {
                        producto.cantidad = 0;
                      });
